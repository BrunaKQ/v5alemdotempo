...
const sessions = [
  {
    ...
    summary: [
      ...
      "A harpia Emilie confirma a dívida ao ler um antigo livro de contas. Com seus poderes, ela que descobre Inês fazia parte do que seria a futura corte de Nova Orleans a bordo de um navio Novo Mundo, porém foram atacados por uma nau repleta de lobisomens. No massacre, Guilhame de Vauclair — senhor de Inês — foi destruído. Mithras interveio, enfrentou a ameaça lupina e salvou Inês da morte final. Também é revelado que o ataque foi orquestrado por LaFontaine, que manipulou os lobisomens para atacar o grupo.",
